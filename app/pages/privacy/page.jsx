        ...
        <div className='card col-md-8 p-3 policy '>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to FreeWsad.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to FreeWsad, accessible from{' '}
                <a
                  href='https://www.freewsad.com'
                  target='_blank'
                  rel='noreferrer'
                >
          ...
          <ul>
            <li>
              ...
              <Link href='/pages/contact' rel='noreferrer'>
                https://www.freewsad.com/contact/
              </Link>
            </li>
          </ul>
        </div>
