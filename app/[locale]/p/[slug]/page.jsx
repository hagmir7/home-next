...
export async function generateMetadata({ params, searchParams }, parent) {
  ...
  // fetch data
  const response = await fetch('https://al-kora.com/en/api/post/' + slug)
  ...
  return {
    ...
    image: 'https://al-kora.com' + post.image,
    ...
    openGraph: {
      title: post.title,
      images: ['https://al-kora.com' + post.image],
      description: post.description.slice(0, 170),
      url: '/p/' + post.slug,
      type: 'article',
      image: {
        url: 'https://al-kora.com' + post.image,
        alt: post.title,
        width: 600,
        height: 800,
      },
...
export default async function Post(props) {
  const response = await fetch(`https://al-kora.com/en/api/post/${props.params.slug}`)
        ...
        >
          <article className='blog-post' style={{ height: 'auto!important' }}>
            ...
            <img
              ...
              src={`https://al-kora.com/${responsData.image}`}
              width='100%'
              height='auto'
